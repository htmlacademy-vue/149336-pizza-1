...
describe('ProfileAddressEdit', () => {
  ...
  it('It sets the initial value', () => {
    ...
    expect(wrapper.find('[data-test="name"] input').element.value).toBe(propsData.adr.name);
    expect(wrapper.find('[data-test="street"] input').element.value).toBe(propsData.adr.street);
    expect(wrapper.find('[data-test="house"] input').element.value).toBe(propsData.adr.building);
    expect(wrapper.find('[data-test="flat"] input').element.value).toBe(propsData.adr.flat);
    expect(wrapper.find('[data-test="comment"] input').element.value).toBe(propsData.adr.comment);
  });
